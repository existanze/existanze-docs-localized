...
module.exports=function(module){
  ...
  function isUniversal(doc, key) {
    ...
    if (_.has(module.options.universal || [], key) || _.has(module.options.universal || [], doc.type + ':' + key)) {
      return;
    }
  }
    ...
    loadLocale:function(results,locale,callback){
      ...
      async.each(results,function(doc,callback){
        ...
        setup(doc,module.locales,function(err,localized){
          ...
          var log = false;//doc._id === "ciy2sv1uq0007l3c29ju8gp0i";

          if(log) console.log("Working with ",localized.docs,locale);
          ...
          _.each(doc, function (value, key) {
            ...
            if(log) console.log("\tLocalizing ",doc._id, key, value);
            ...
            //TODO fix this
            if (localized.docs[locale][key].items && localized.docs[locale][key].items[0] && localized.docs[locale][key].items[0].pieceIds){
              return;
            }
